...
class MyUser(models.Model):
    ...
    role = models.CharField(
        max_length=100, choices=TYPES_OF_USERS, default=TYPES_OF_USERS[0][0])
...
class Facility(models.Model):
    kind = models.CharField(
        max_length=100, choices=PHCorCHC, default=TYPES_OF_USERS[0][0])
...
class FamilyDetails(models.Model):
    ...
    relation = models.CharField(
        max_length=100, choices=RELATIONS, default=TYPES_OF_USERS[0][0])
    address = models.TextField()
...
class Disease(models.Model):
    disease = models.CharField(
        max_length=100, choices=DISEASES, default=TYPES_OF_USERS[0][0])
